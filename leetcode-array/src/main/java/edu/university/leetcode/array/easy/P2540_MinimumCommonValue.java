 ...
 * Example 1: Input: nums1 = [1,2,3], nums2 = [2,4] Output: 2
 * Explanation: The smallest element common to both arrays is 2, so we return 2.
 * Example 2: Input: nums1 = [1,2,3,6], nums2 = [2,3,4,5] Output: 2
...
public class P2540_MinimumCommonValue {
    ...
    public static void main(String[] args) {
        P2540_MinimumCommonValue test = new P2540_MinimumCommonValue();
